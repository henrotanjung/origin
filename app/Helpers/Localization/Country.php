...
class Country
{
    ...
    public function __construct()
    {
        ...
        self::$cacheExpiration = config('settings.app_cache_expiration');
    ...
    public static function getCountryInfo($countryCode)
    {
        ...
        $country = Cache::rememberForever('country.' . $countryCode, function () use ($countryCode) {
        ...
        $currency = Cache::rememberForever('currency.' . $country['currency_code'], function () use($country) {
        ...
        $timeZone = Cache::rememberForever('timeZone.where.countryCode' . $countryCode, function () use($countryCode) {
    ...
    public static function getLangFromCountry($languages)
    {
        ...
        if (trim($languages) != '') {
            ...
            // Get all languages
            $availableLanguages = Cache::rememberForever('languages.all', function () {
        ...
        // Get language info
        if ($langCode != '') {
            $isAvailableLang = Cache::rememberForever('language.' . $langCode, function () use($langCode) {
    ...
    public static function getLangFromConfig()
    {
        ...
        $lang = Cache::rememberForever('language.' . $langCode, function () use($langCode) {
    ...
    public static function getCountries()
    {
        ...
        try {
            $countries = Cache::rememberForever('countries.with.continent.currency', function () {
