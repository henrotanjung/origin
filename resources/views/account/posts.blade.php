								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										...
										<td style="width:10%" class="action-td">
											<div>
												@if ($post->user_id==$user->id and in_array($post->active, [0, 1]) and $post->archived==0)
													<p>
												...
												@endif
												@if ($post->active==1 and $post->archived==0)
													<!--<p>
												...
												@endif
                                                                                                <p>
                                                                                                    <a class="btn btn-primary btn-xs" href="http://localhost/laraclassified32/public/posts/3/packages">
                                                            <i class="fa fa-edit"></i> {{ t('Sundul Iklan') }}
                                                        </a>
                                                                                                </p>
												<p>
